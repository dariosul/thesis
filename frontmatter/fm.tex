\newcommand\thesistitle{Localization Algorithms for Passive Sensor Networks}
% One needs to make adjustments for a Master's Thesis
\newcommand\nameanddegrees{%
Darya Ismailova\\
B.Sc., University of Astrakhan, 2010}
\newcommand\panel{%
\HRule\\\panelist{Dr. Wu-Sheng Lu}{Supervisor}{Department of Electrical and Computer Engineering}
\HRule\\\panelist{Dr. Pan Agathoklis}{Departmental Member}{Department of Electrical and Computer Engineering}}
