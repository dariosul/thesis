...
The following m-files implement the sequential convex relaxation for solving the localization problem based on range-difference measurements. The implementation follow the alrorithm developed in Sec.4.1.
