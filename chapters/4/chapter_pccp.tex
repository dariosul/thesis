...
Let $\mathcal{D}$ be a nonempty set in $R^n$. A vector $\Bh \in R^n$ is said to be a subgradient of  a convex function $f:\mathcal{D} \rightarrow R$  at $\Bx \in \mathcal{D}$ if \cite{AntonLu}
\begin{equation}
\nonumber
f(\By) \geq f(\Bx) + \Bg^T (\By - \Bx) \mbox{for all } \By \in \mathcal{D}
\end{equation}
