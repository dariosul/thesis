...
\ref{fig:MSE} shows the bar chart of location estimation errors for SR-LS solution and the proposed algorithm for various number of sensors. Each entry is a square error of the method averaged over 50 random initializations of the system 
 consisting of $m$ sensors, with $m$ being one of $\{4, 5, 7, 10\}$.

\begin{figure} \label{fig:MSE}
\centering
 \includegraphics[width=0.45\textwidth]{figures/ccp/MSE_1e3}
 \hfill
  \includegraphics[width=0.45\textwidth]{figures/ccp/MSE_1e2}
\end{figure}

\begin{figure}[h]
\centering
 \includegraphics[width=0.45\textwidth]{figures/ccp/MSE_1e1}
 \hfill
  \includegraphics[width=0.45\textwidth]{figures/ccp/MSE_1e0} 
\caption{MSE} 
\end{figure}